...
- 제휴 준비물: 입원 생활에 필요한 비의료 생활용품을 쿠팡파트너스 링크로 안내합니다. 질환·기록에 따른 개인화는 하지 않으며, 약·건강기능식품·의료기기는 추천하지 않습니다. 모든 제휴 링크에는 수수료 고지를 함께 표시합니다. 자세한 기준은 `docs/AFFILIATE_COMMERCE.md`를 참고하세요.
...
출시 전 운영자 정보, 보존기간, 개인정보 처리방침·약관, 제휴 표시 방식은 법률 전문가 검토가 필요합니다. 세부 운영 기준은 `docs/` 문서를 참고하세요.
